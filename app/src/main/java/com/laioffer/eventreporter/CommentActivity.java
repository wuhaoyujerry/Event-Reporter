  ...
  private void getData ( final String eventId, final CommentAdapter commentAdapter){
    mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
      ...
      public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        // Use a new snapshot so we can get the updated comment number
        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
          @Override
          public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            for (DataSnapshot noteDataSnapshot : eventSnapshot.getChildren()) {
              ...
              if (event.getId().equals(eventId)) {
                // pass the current event into commentactivity so that we can get all the info
                // of this current event in commentadapter
            ...
            if (mRecyclerView.getAdapter() != null) {
              ...
              // set the adapter for recylerview to display the event and its all comments
