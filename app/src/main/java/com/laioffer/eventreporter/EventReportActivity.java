...
public class EventReportActivity extends AppCompatActivity {
  ...
  private ImageView img_event_location;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    img_event_location = (ImageView) findViewById(R.id.img_event_location);
  ...
  /**
   * Gather information inserted by user and create event for uploading. Then clear those widgets if
   * user uploads one
   *
